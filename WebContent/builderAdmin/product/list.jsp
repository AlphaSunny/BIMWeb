...
<body>
	...
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/builderSearchWindow" method="post">
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td width="5%" align="center">finish</td>
							...
							<c:forEach items="${windowList }" var="win" varStatus="vs">
									...
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										href="${ pageContext.request.contextPath }/builderAdminFinishWindow?wid=${win.wid}">
											<img
										...
										<td align="center" style="HEIGHT: 22px"><a
											href="${ pageContext.request.contextPath }/builderEditUI?wid=${win.wid}">
												<img
