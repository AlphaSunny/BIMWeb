...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/proprietorSearchWindow" method="post">
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="6%">ID</td>
								<td align="center" width="6%">Floor</td>
							...
							<c:forEach items="${windowList }" var="win" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									href="${ pageContext.request.contextPath }/proprietorEditPriceUI?wid=${win.wid}">
										<img
									...
									<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/proprietorEditDeadlineUI?wid=${win.wid}">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand"></a>
									</td>
									...
									<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/proprietorEditDescUI?wid=${win.wid}">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand"></a>
									</td>
